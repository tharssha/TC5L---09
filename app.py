...
def profile():
    ...
    if request.method == 'POST':
        ...
        job_roles = request.form.getlist('user_jobrole')
            ...
            with get_db_connection() as con:
                ...
                if existing_profile:
                    ...
                    cur.execute('''UPDATE resume 
                                   ...
                                   WHERE email = ?''', 
                               (user_name, hashed_password, user_age, user_bio, user_status, user_faculty, job_roles_str, user_email))
                else:
                    ...
                    cur.execute('''INSERT INTO resume (name, email, password, age, bio, status, faculty, job_roles)
                                   VALUES (?, ?, ?, ?, ?, ?, ?, ?)''', 
                                (user_name, user_email, hashed_password, user_age, user_bio, user_status, user_faculty, job_roles_str))
...
>>>>>>> 96c2b7a99deee2e4c74d1ea7610e2ce02e892191
